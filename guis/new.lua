...
local getcustomassets = {
	...
	['katware/assets/new/guivape.png'] = 'rbxassetid://14657521312',
	...
	['katware/assets/new/textvape.png'] = 'rbxassetid://14368358200',
	['katware/assets/new/utilityicon.png'] = 'rbxassetid://14368359107',
	['katware/assets/new/vape.png'] = 'rbxassetid://14373395239',
...
function mainapi:CreateGUI()
	...
	logo.Image = getcustomasset('katware/assets/new/guivape.png')
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('katware/assets/new/vape.png')
		image.Parent = button
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/XxlyitemXx/katware/loader.lua', true))()
		end
	end,
	...
	Function = function(val, mouse)
		if mouse then
			...
			if shared.VapeDeveloper then
				...
				loadstring(game:HttpGet('https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/''..'/loader.lua', true))()
			end
		end
	end,
...
VapeLogo.Image = getcustomasset('katware/assets/new/textvape.png')
...
VapeLogoV4.Image = getcustomasset('katware/assets/new/textv4.png')

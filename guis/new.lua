...
local getcustomassets = {
	...
	['katware/assets/new/guiv4.png'] = 'rbxassetid://14368322199',
	['katware/assets/new/guikatware.png'] = 'rbxassetid://14657521312',
	...
	['katware/assets/new/textkatware.png'] = 'rbxassetid://14368358200',
	['katware/assets/new/utilityicon.png'] = 'rbxassetid://14368359107',
	['katware/assets/new/katware.png'] = 'rbxassetid://14373395239',
...
local function addBlur(parent, notif)
	...
	blur.Image = getcustomasset('katware/assets/new/'..(notif and 'blurnotif' or 'blur')..'.png')
...
local function addCloseButton(parent, offset)
	...
	close.Image = getcustomasset('katware/assets/new/close.png')
...
do
	local res = isfile('katware/profiles/color.txt') and loadJson('katware/profiles/color.txt')
	if res then
...
components = {
	...
	ColorSlider = function(optionsettings, children, api)
		...
		preview.Image = getcustomasset('katware/assets/new/colorpreview.png')
		...
		expand.Image = getcustomasset('katware/assets/new/expandicon.png')
		...
		rainbow1.Image = getcustomasset('katware/assets/new/rainbow_1.png')
		rainbow1.ImageColor3 = color.Light(uipallet.Main, 0.37)
		rainbow1.Parent = rainbow
		local rainbow2 = rainbow1:Clone()
		rainbow2.Image = getcustomasset('katware/assets/new/rainbow_2.png')
		rainbow2.Parent = rainbow
		local rainbow3 = rainbow1:Clone()
		rainbow3.Image = getcustomasset('katware/assets/new/rainbow_3.png')
		rainbow3.Parent = rainbow
		local rainbow4 = rainbow1:Clone()
		rainbow4.Image = getcustomasset('katware/assets/new/rainbow_4.png')
	...
	Dropdown = function(optionsettings, children, api)
		...
		arrow.Image = getcustomasset('katware/assets/new/expandright.png')
	...
	Targets = function(optionsettings, children, api)
		...
		icon.Image = getcustomasset('katware/assets/new/targetstab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		...
		optionapi.Players = components.TargetsButton({
			...
			Icon = getcustomasset('katware/assets/new/targetplayers1.png'),
			IconSize = UDim2.fromOffset(15, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('katware/assets/new/targetplayers2.png'),
		...
		optionapi.NPCs = components.TargetsButton({
			...
			Icon = getcustomasset('katware/assets/new/targetnpc1.png'),
			IconSize = UDim2.fromOffset(12, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('katware/assets/new/targetnpc2.png'),
	...
	TextList = function(optionsettings, children, api)
		...
		buttonicon.Image = optionsettings.Icon or getcustomasset('katware/assets/new/allowedicon.png')
		...
		icon.BackgroundTransparency = 1
		icon.Image = optionsettings.Tab or getcustomasset('katware/assets/new/allowedtab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		title.Size = UDim2.new(1, -36, 0, 20)
		...
		addbutton.Image = getcustomasset('katware/assets/new/add.png')
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				close.BackgroundTransparency = 1
				close.AutoButtonColor = false
				close.Image = getcustomasset('katware/assets/new/closemini.png')
				close.ImageColor3 = color.Light(uipallet.Text, 0.2)
				close.ImageTransparency = 0.5
				close.Parent = object
				addCorner(close, UDim.new(1, 0))
	...
	TwoSlider = function(optionsettings, children, api)
		...
		knob.Image = getcustomasset('katware/assets/new/range.png')
		...
		arrow.BackgroundTransparency = 1
		arrow.Image = getcustomasset('katware/assets/new/rangearrow.png')
...
function mainapi:CreateGUI()
	...
	logo.Name = 'katwareLogo'
	logo.Size = UDim2.fromOffset(62, 18)
	logo.Position = UDim2.fromOffset(11, 10)
	logo.BackgroundTransparency = 1
	logo.Image = getcustomasset('katware/assets/new/guikatware.png')
	...
	logov4.Image = getcustomasset('katware/assets/new/guiv4.png')
	logov4.Parent = logo
	...
	settingsicon.Image = getcustomasset('katware/assets/new/guisettings.png')
	...
	back.Image = getcustomasset('katware/assets/new/back.png')
	...
	settingsversion.Text = 'katware '..mainapi.Version..' '..(
		isfile('katware/profiles/commit.txt') and readfile('katware/profiles/commit.txt'):sub(1, 6) or ''
	)..' '
	...
	function categoryapi:CreateBind()
		...
		icon.BackgroundTransparency = 1
		icon.Image = getcustomasset('katware/assets/new/bind.png')
		...
		function optionapi:SetBind(tab)
			...
			if mainapi.katwareButton then
				mainapi.katwareButton:Destroy()
				mainapi.katwareButton = nil
			end
		...
		bind.MouseEnter:Connect(function()
			...
			icon.Image = getcustomasset('katware/assets/new/edit.png')
	...
	function categoryapi:CreateOverlayBar()
		...
		button.AutoButtonColor = false
		button.Image = getcustomasset('katware/assets/new/overlaysicon.png')
		...
		icon.Position = UDim2.fromOffset(10, 13)
		icon.BackgroundTransparency = 1
		icon.Image = getcustomasset('katware/assets/new/overlaystab.png')
	...
	function categoryapi:CreateGUISlider(optionsettings)
		...
		expandicon.Image = getcustomasset('katware/assets/new/expandicon.png')
		...
		knob.BackgroundTransparency = 1
		knob.Image = getcustomasset('katware/assets/new/guislider.png')
		...
		local normalknob = getcustomasset('katware/assets/new/guislider.png')
		local rainbowknob = getcustomasset('katware/assets/new/guisliderrain.png')
		local rainbowthread
...
function mainapi:CreateCategory(categorysettings)
	...
	arrow.BackgroundTransparency = 1
	arrow.Image = getcustomasset('katware/assets/new/expandup.png')
	arrow.ImageColor3 = Color3.fromRGB(140, 140, 140)
	arrow.Rotation = 180
	...
	function categoryapi:CreateModule(modulesettings)
		...
		bindicon.Image = getcustomasset('katware/assets/new/bind.png')
		...
		bindcover.Image = getcustomasset('katware/assets/new/bindbkg.png')
		...
		dots.Image = getcustomasset('katware/assets/new/dots.png')
		...
		bind.MouseEnter:Connect(function()
			...
			bindicon.Image = getcustomasset('katware/assets/new/edit.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('katware/assets/new/pin.png')
...
function mainapi:CreateCategoryList(categorysettings)
	...
	settings.Image = getcustomasset('katware/assets/new/customsettings.png')
			...
			if categorysettings.Profiles then
				...
				if ind then
					if val ~= 'default' then
						...
						if isfile('katware/profiles/'..val..mainapi.Place..'.txt') and delfile then
							delfile('katware/profiles/'..val..mainapi.Place..'.txt')
						end
					end
				else
...
function mainapi:CreateSearch()
	...
	searchicon.Image = getcustomasset('katware/assets/new/search.png')
	...
	legiticon.Image = getcustomasset('katware/assets/new/legit.png')
...
function mainapi:CreateLegit()
	...
	icon.BackgroundTransparency = 1
	icon.Image = getcustomasset('katware/assets/new/legittab.png')
	icon.ImageColor3 = uipallet.Text
	icon.Parent = window
	local close = addCloseButton(window)
	local children = Instance.new('ScrollingFrame')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		notification.Image = getcustomasset('katware/assets/new/notification.png')
		...
		iconshadow.Image = getcustomasset('katware/assets/new/'..(type or 'info')..'.png')
...
function mainapi:Load(skipgui, profile)
	...
	if isfile('katware/profiles/'..game.GameId..'.gui.txt') then
	...
	if isfile('katware/profiles/'..self.Profile..self.Place..'.txt') then
		local savedata = loadJson('katware/profiles/'..self.Profile..self.Place..'.txt')
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('katware/assets/new/katware.png')
		image.Parent = button
		local buttoncorner = Instance.new('UICorner')
		buttoncorner.Parent = button
		self.katwareButton = button
		button.MouseButton1Click:Connect(function()
			if self.ThreadFix then
				setthreadidentity(8)
			end
...
function mainapi:Save(newprofile)
	...
	writefile('katware/profiles/'..game.GameId..'.gui.txt', httpService:JSONEncode(guidata))
	writefile('katware/profiles/'..self.Profile..self.Place..'.txt', httpService:JSONEncode(savedata))
end
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('katware/assets/new/combaticon.png'),
	Size = UDim2.fromOffset(13, 14)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('katware/assets/new/blatanticon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('katware/assets/new/rendericon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('katware/assets/new/utilityicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('katware/assets/new/worldicon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('katware/assets/new/inventoryicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('katware/assets/new/miniicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('katware/assets/new/profilesicon.png'),
...
general:CreateButton({
	...
	mainapi.Save = function() end
		if isfile('katware/profiles/'..mainapi.Profile..mainapi.Place..'.txt') and delfile then
			delfile('katware/profiles/'..mainapi.Profile..mainapi.Place..'.txt')
		end
	...
	Tooltip = 'This will set your profile to the default settings of katware'
})
general:CreateButton({
	Name = 'Self destruct',
	Function = function()
	...
	Tooltip = 'Removes katware from the current game'
})
general:CreateButton({
	Name = 'Reinject',
	Function = function()
	...
	Tooltip = 'Reloads katware for debugging purposes'
})
...
guipane:CreateDropdown({
	...
	Tooltip = 'new - The newest katware theme to since v4.05\nold - The katware theme pre v4.05\nrise - Rise 6.0'
})
...
local katwareTextScale = Instance.new('UIScale')
katwareTextScale.Parent = textgui.Children
...
local textguiwatermark = textgui:CreateToggle({
	Name = 'Watermark',
	Tooltip = 'Renders a katware watermark',
	Function = function()
		mainapi:UpdateTextGUI()
	end
})
...
textguimoduleslist = textgui:CreateTextList({
	...
	Icon = getcustomasset('katware/assets/new/blockedicon.png'),
	Tab = getcustomasset('katware/assets/new/blockedtab.png'),
...
local katwareLabels = {}
local katwareLogo = Instance.new('ImageLabel')
katwareLogo.Name = 'Logo'
katwareLogo.Size = UDim2.fromOffset(80, 21)
katwareLogo.Position = UDim2.new(1, -142, 0, 3)
katwareLogo.BackgroundTransparency = 1
katwareLogo.BorderSizePixel = 0
katwareLogo.Visible = false
katwareLogo.BackgroundColor3 = Color3.new()
katwareLogo.Image = getcustomasset('katware/assets/new/textkatware.png')
katwareLogo.Parent = textgui.Children
...
local katwareLogoV4 = Instance.new('ImageLabel')
katwareLogoV4.Name = 'Logo2'
katwareLogoV4.Size = UDim2.fromOffset(33, 18)
katwareLogoV4.Position = UDim2.new(1, 1, 0, 1)
katwareLogoV4.BackgroundColor3 = Color3.new()
katwareLogoV4.BackgroundTransparency = 1
katwareLogoV4.BorderSizePixel = 0
katwareLogoV4.Image = getcustomasset('katware/assets/new/textv4.png')
katwareLogoV4.Parent = katwareLogo
local katwareLogoShadow = katwareLogo:Clone()
katwareLogoShadow.Position = UDim2.fromOffset(1, 1)
katwareLogoShadow.ZIndex = 0
katwareLogoShadow.Visible = true
katwareLogoShadow.ImageColor3 = Color3.new()
katwareLogoShadow.ImageTransparency = 0.65
katwareLogoShadow.Parent = katwareLogo
katwareLogoShadow.Logo2.ZIndex = 0
katwareLogoShadow.Logo2.ImageColor3 = Color3.new()
katwareLogoShadow.Logo2.ImageTransparency = 0.65
local katwareLogoGradient = Instance.new('UIGradient')
katwareLogoGradient.Rotation = 90
katwareLogoGradient.Parent = katwareLogo
local katwareLogoGradient2 = Instance.new('UIGradient')
katwareLogoGradient2.Rotation = 90
katwareLogoGradient2.Parent = katwareLogoV4
local katwareLabelCustom = Instance.new('TextLabel')
katwareLabelCustom.Position = UDim2.fromOffset(5, 2)
katwareLabelCustom.BackgroundTransparency = 1
katwareLabelCustom.BorderSizePixel = 0
katwareLabelCustom.Visible = false
katwareLabelCustom.Text = ''
katwareLabelCustom.TextSize = 25
katwareLabelCustom.FontFace = textguifontcustom.Value
katwareLabelCustom.RichText = true
local katwareLabelCustomShadow = katwareLabelCustom:Clone()
katwareLabelCustom:GetPropertyChangedSignal('Position'):Connect(function()
	katwareLabelCustomShadow.Position = UDim2.new(
		katwareLabelCustom.Position.X.Scale,
		katwareLabelCustom.Position.X.Offset + 1,
		0,
		katwareLabelCustom.Position.Y.Offset + 1
	)
end)
katwareLabelCustom:GetPropertyChangedSignal('FontFace'):Connect(function()
	katwareLabelCustomShadow.FontFace = katwareLabelCustom.FontFace
end)
katwareLabelCustom:GetPropertyChangedSignal('Text'):Connect(function()
	katwareLabelCustomShadow.Text = removeTags(katwareLabelCustom.Text)
end)
katwareLabelCustom:GetPropertyChangedSignal('Size'):Connect(function()
	katwareLabelCustomShadow.Size = katwareLabelCustom.Size
end)
katwareLabelCustomShadow.TextColor3 = Color3.new()
katwareLabelCustomShadow.TextTransparency = 0.65
katwareLabelCustomShadow.Parent = textgui.Children
katwareLabelCustom.Parent = textgui.Children
local katwareLabelHolder = Instance.new('Frame')
katwareLabelHolder.Name = 'Holder'
katwareLabelHolder.Size = UDim2.fromScale(1, 1)
katwareLabelHolder.Position = UDim2.fromOffset(5, 37)
katwareLabelHolder.BackgroundTransparency = 1
katwareLabelHolder.Parent = textgui.Children
local katwareLabelSorter = Instance.new('UIListLayout')
katwareLabelSorter.HorizontalAlignment = Enum.HorizontalAlignment.Right
katwareLabelSorter.VerticalAlignment = Enum.VerticalAlignment.Top
katwareLabelSorter.SortOrder = Enum.SortOrder.LayoutOrder
katwareLabelSorter.Parent = katwareLabelHolder
...
targetinfoobj = mainapi:CreateOverlay({
	Name = 'Target Info',
	Icon = getcustomasset('katware/assets/new/targetinfoicon.png'),
	Size = UDim2.fromOffset(14, 14),
	Position = UDim2.fromOffset(12, 14),
	CategorySize = 240,
	Function = function(callback)
...
function mainapi:UpdateTextGUI(afterload)
	...
	if textgui.Button.Enabled then
		...
		katwareLogo.Visible = textguiwatermark.Enabled
		katwareLogo.Position = right and UDim2.new(1 / katwareTextScale.Scale, -113, 0, 6) or UDim2.fromOffset(0, 6)
		katwareLogoShadow.Visible = textguishadow.Enabled
		katwareLabelCustom.Text = textguibox.Value
		katwareLabelCustom.FontFace = textguifontcustom.Value
		katwareLabelCustom.Visible = katwareLabelCustom.Text ~= '' and textguitext.Enabled
		katwareLabelCustomShadow.Visible = katwareLabelCustom.Visible and textguishadow.Enabled
		katwareLabelSorter.HorizontalAlignment = right and Enum.HorizontalAlignment.Right or Enum.HorizontalAlignment.Left
		katwareLabelHolder.Size = UDim2.fromScale(1 / katwareTextScale.Scale, 1)
		katwareLabelHolder.Position = UDim2.fromOffset(right and 3 or 0, 11 + (katwareLogo.Visible and katwareLogo.Size.Y.Offset or 0) + (katwareLabelCustom.Visible and 28 or 0) + (textguibackground.Enabled and 3 or 0))
		if katwareLabelCustom.Visible then
			local size = getfontsize(removeTags(katwareLabelCustom.Text), katwareLabelCustom.TextSize, katwareLabelCustom.FontFace)
			katwareLabelCustom.Size = UDim2.fromOffset(size.X, size.Y)
			katwareLabelCustom.Position = UDim2.new(right and 1 / katwareTextScale.Scale or 0, right and -size.X or 0, 0, (katwareLogo.Visible and 32 or 8))
		end

		local found = {}
		for _, v in katwareLabels do
			if v.Enabled then
				table.insert(found, v.Object.Name)
			end
			v.Object:Destroy()
		end
		table.clear(katwareLabels)
		...
		for i, v in mainapi.Modules do
			...
			if v.Enabled or table.find(found, i) then
				...
				holder.Parent = katwareLabelHolder
		...
		if textguisort.Value == 'Alphabetical' then
			table.sort(katwareLabels, function(a, b)
...
function mainapi:UpdateGUI(hue, sat, val, default)
	...
	if textgui.Button.Enabled then
		katwareLogoGradient.Color = ColorSequence.new({
		...
		katwareLogoGradient2.Color = textguigradient.Enabled and textguigradientv4.Enabled and katwareLogoGradient.Color or ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.new(1, 1, 1)),
			ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))
		})
		katwareLabelCustom.TextColor3 = textguicolorcustomtoggle.Enabled and Color3.fromHSV(textguicolorcustom.Hue, textguicolorcustom.Sat, textguicolorcustom.Value) or katwareLogoGradient.Color.Keypoints[2].Value
		...
		for i, v in katwareLabels do
			v.Text.TextColor3 = customcolor or (mainapi.GUIColor.Rainbow and Color3.fromHSV(mainapi:Color((hue - ((textguigradient and i + 2 or i) * 0.025)) % 1)) or katwareLogoGradient.Color.Keypoints[2].Value)
			if v.Color then
	...
	for i, v in mainapi.Categories do
		if i == 'Main' then
			v.Object.katwareLogo.V4Logo.ImageColor3 = Color3.fromHSV(hue, sat, val)

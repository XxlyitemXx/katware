...
local function addBlur(parent, notif)
	...
	blur.Image = getcustomasset('assets/new/'..(notif and 'blurnotif' or 'blur')..'.png')
...
local function addCloseButton(parent, offset)
	...
	close.Image = getcustomasset('assets/new/close.png')
...
components = {
	...
	ColorSlider = function(optionsettings, children, api)
		...
		preview.Image = getcustomasset('assets/new/colorpreview.png')
		...
		expand.Image = getcustomasset('assets/new/expandicon.png')
		...
		rainbow1.Image = getcustomasset('assets/new/rainbow_1.png')
		rainbow1.ImageColor3 = color.Light(uipallet.Main, 0.37)
		rainbow1.Parent = rainbow
		local rainbow2 = rainbow1:Clone()
		rainbow2.Image = getcustomasset('assets/new/rainbow_2.png')
		rainbow2.Parent = rainbow
		local rainbow3 = rainbow1:Clone()
		rainbow3.Image = getcustomasset('assets/new/rainbow_3.png')
		rainbow3.Parent = rainbow
		local rainbow4 = rainbow1:Clone()
		rainbow4.Image = getcustomasset('assets/new/rainbow_4.png')
	...
	Dropdown = function(optionsettings, children, api)
		...
		arrow.Image = getcustomasset('assets/new/expandright.png')
	...
	Targets = function(optionsettings, children, api)
		...
		icon.Image = getcustomasset('assets/new/targetstab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		...
		optionapi.Players = components.TargetsButton({
			...
			Icon = getcustomasset('assets/new/targetplayers1.png'),
			IconSize = UDim2.fromOffset(15, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('assets/new/targetplayers2.png'),
		...
		optionapi.NPCs = components.TargetsButton({
			...
			Icon = getcustomasset('assets/new/targetnpc1.png'),
			IconSize = UDim2.fromOffset(12, 16),
			IconParent = tool,
			ToolIcon = getcustomasset('assets/new/targetnpc2.png'),
	...
	TextList = function(optionsettings, children, api)
		...
		buttonicon.Image = optionsettings.Icon or getcustomasset('assets/new/allowedicon.png')
		...
		icon.BackgroundTransparency = 1
		icon.Image = optionsettings.Tab or getcustomasset('assets/new/allowedtab.png')
		icon.Parent = window
		local title = Instance.new('TextLabel')
		title.Name = 'Title'
		title.Size = UDim2.new(1, -36, 0, 20)
		...
		addbutton.Image = getcustomasset('assets/new/add.png')
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				close.BackgroundTransparency = 1
				close.AutoButtonColor = false
				close.Image = getcustomasset('assets/new/closemini.png')
				close.ImageColor3 = color.Light(uipallet.Text, 0.2)
				close.ImageTransparency = 0.5
				close.Parent = object
				addCorner(close, UDim.new(1, 0))
	...
	TwoSlider = function(optionsettings, children, api)
		...
		knob.Image = getcustomasset('assets/new/range.png')
		...
		arrow.BackgroundTransparency = 1
		arrow.Image = getcustomasset('assets/new/rangearrow.png')
...
function mainapi:CreateGUI()
	...
	logo.Image = getcustomasset('assets/new/guivape.png')
	...
	logov4.Image = getcustomasset('assets/new/guiv4.png')
	logov4.Parent = logo
	...
	settingsicon.Image = getcustomasset('assets/new/guisettings.png')
	...
	back.Image = getcustomasset('assets/new/back.png')
	...
	function categoryapi:CreateBind()
		...
		icon.BackgroundTransparency = 1
		icon.Image = getcustomasset('assets/new/bind.png')
		...
		bind.MouseEnter:Connect(function()
			...
			icon.Image = getcustomasset('assets/new/edit.png')
	...
	function categoryapi:CreateOverlayBar()
		...
		button.AutoButtonColor = false
		button.Image = getcustomasset('assets/new/overlaysicon.png')
		...
		icon.Position = UDim2.fromOffset(10, 13)
		icon.BackgroundTransparency = 1
		icon.Image = getcustomasset('assets/new/overlaystab.png')
	...
	function categoryapi:CreateGUISlider(optionsettings)
		...
		expandicon.Image = getcustomasset('assets/new/expandicon.png')
		...
		knob.BackgroundTransparency = 1
		knob.Image = getcustomasset('assets/new/guislider.png')
		...
		local normalknob = getcustomasset('assets/new/guislider.png')
		local rainbowknob = getcustomasset('assets/new/guisliderrain.png')
		local rainbowthread
...
function mainapi:CreateCategory(categorysettings)
	...
	arrow.BackgroundTransparency = 1
	arrow.Image = getcustomasset('assets/new/expandup.png')
	arrow.ImageColor3 = Color3.fromRGB(140, 140, 140)
	arrow.Rotation = 180
	...
	function categoryapi:CreateModule(modulesettings)
		...
		bindicon.Image = getcustomasset('assets/new/bind.png')
		...
		bindcover.Image = getcustomasset('assets/new/bindbkg.png')
		...
		dots.Image = getcustomasset('assets/new/dots.png')
		...
		bind.MouseEnter:Connect(function()
			...
			bindicon.Image = getcustomasset('assets/new/edit.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('assets/new/pin.png')
...
function mainapi:CreateCategoryList(categorysettings)
	...
	settings.Image = getcustomasset('assets/new/customsettings.png')
...
function mainapi:CreateSearch()
	...
	searchicon.Image = getcustomasset('assets/new/search.png')
	...
	legiticon.Image = getcustomasset('assets/new/legit.png')
...
function mainapi:CreateLegit()
	...
	icon.BackgroundTransparency = 1
	icon.Image = getcustomasset('assets/new/legittab.png')
	icon.ImageColor3 = uipallet.Text
	icon.Parent = window
	local close = addCloseButton(window)
	local children = Instance.new('ScrollingFrame')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		notification.Image = getcustomasset('assets/new/notification.png')
		...
		iconshadow.Image = getcustomasset('assets/new/'..(type or 'info')..'.png')
...
function mainapi:Load(skipgui, profile)
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('assets/new/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('assets/new/combaticon.png'),
	Size = UDim2.fromOffset(13, 14)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('assets/new/blatanticon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('assets/new/rendericon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('assets/new/utilityicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('assets/new/worldicon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('assets/new/inventoryicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Minigames',
	Icon = getcustomasset('assets/new/miniicon.png'),
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('assets/new/friendstab.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('assets/new/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('assets/new/textguiicon.png'),
...
textguimoduleslist = textgui:CreateTextList({
	...
	Icon = getcustomasset('assets/new/blockedicon.png'),
	Tab = getcustomasset('assets/new/blockedtab.png'),
...
VapeLogo.Image = getcustomasset('assets/new/textvape.png')
...
VapeLogoV4.Image = getcustomasset('assets/new/textv4.png')
...
targetinfoobj = mainapi:CreateOverlay({
	Name = 'Target Info',
	Icon = getcustomasset('assets/new/targetinfoicon.png'),
	Size = UDim2.fromOffset(14, 14),
	Position = UDim2.fromOffset(12, 14),
	CategorySize = 240,
	Function = function(callback)

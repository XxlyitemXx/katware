...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('katware/profiles/whitelist.json') and readfile('katware/profiles/whitelist.json') or nil
			end
			local suc, res = pcall(function()
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('katware/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		EntityArrow.Image = getcustomasset('katware/assets/new/arrowmodule.png')

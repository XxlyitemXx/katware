...
run(function()
	...
	InfiniteStamina = katware.Categories.Blatant:CreateModule({
...
run(function()
	...
	AutoEat = katware.Categories.Utility:CreateModule({
		Name = 'AutoEat',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	AutoPickup = katware.Categories.Utility:CreateModule({
		Name = 'AutoPickup',
		Function = function(callback)
			if callback then 
